            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">View User-Project-Permissions</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item active">View User-Project-Permissions</li>
                        </ol>
                    </div>                    
                </div>
                <!-- ============================================================== -->
                      ...
                      if(count($dbSelect)) {
                          foreach ($dbSelect as $row) {
                              ...
                              <tr>
                                  ...
                                  <td> <form method="post" action="updateUPP.php"> <input type="hidden" name="myuppid"  value="<?php echo $row['uppid'];?>"> <button id="btn" type="submit" name="btnView" class="btn btn-success">Update</button> </form> </td>
                              </tr>
