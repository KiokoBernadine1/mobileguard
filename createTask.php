            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Create Task</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Create Task Form</h4>
                            </div>
                            <div class="card-block">
                                <form class="m-t-40" novalidate action="" method="POST">
                                    <div class="form-body">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="taskname" class="form-control" required data-validation-required-message="This field is required"> </div>
                            ...
                            ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="description" id="textarea" class="form-control" required placeholder="Describe the above task"></textarea>
                                        </div>
                                    </div>  
                                    </div>
                                    ...
                                    if (isset($error)) 
                                    {
                                        ...
                                        {
                                            $insertQuery="INSERT INTO `Task` (`taskid`, `taskname`, `description`, `startdate`, `enddate`, `status`, `projectid`, `userid`, `updated_at`) VALUES (NULL, '".$taskname."', '".$description."', '".$startdate."', '".$enddate."', '".$status."', '".$projectid."', '".$userid."', current_timestamp()); ";
