 ...
 */
 ...
 $selectQuery="SELECT C.commentid, C.comment_text, C.updated_at, U.firstname,T.taskname FROM Comment C, User U, Task T WHERE C.userid=U.userid AND T.taskid=C.taskid";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">View Comment</h3>
                        <ol class="breadcrumb">
