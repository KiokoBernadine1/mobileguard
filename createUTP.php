            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Create User-Task-Permissions</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item active">Create User-Task-Permissions</li>
                        </ol>
                    </div>                    
                </div>
                <!-- ============================================================== -->
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">User-Task-Permissions Form</h4>
                            </div>
                            <div class="card-block">
                                <form class="m-t-40" novalidate action="" method="POST">
                                    <div class="form-body">
                                        <h3 class="card-title">Add User-Task-Permissions Information</h3>
                                        <hr>
                            ...
                            ?>
                                    ...
                                    if (isset($error)) 
                                    {
                                        ...
                                        {
                                            $insertQuery="INSERT INTO `User_Task_Permission` (`utpid`, `userid`, `taskid`, `permissionid`, `updated_at`) VALUES (NULL, '".$userid."', '".$taskid."', '".$permissionid."', current_timestamp()); ";
